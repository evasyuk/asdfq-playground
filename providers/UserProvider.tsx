...
const UserDefault = {
  ...
  photo: '',
  skills: [UserOptions.MOTORCYCLE_ISSURANCE, CarOptions.MOTORCYCLE, PropertyOptions.HOUSE, PropertyOptions.GARAGE],
}
...
export const UserProvider: ViewWrapperProps = ({ children }) => {
  return <UserProviderContext.Provider value={{ user: UserDefault as User }}>{children}</UserProviderContext.Provider>
}
